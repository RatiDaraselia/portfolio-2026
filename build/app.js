...
function CursorDot({ enabled }) {
  ...
  React.useEffect(() => {
    ...
    const setBlend = (mode) => {
      if (wrap) wrap.style.mixBlendMode = mode;
    };
    const onOver = (e) => {
      ...
      if (e.target.closest && e.target.closest(tgSel)) {
        dot.classList.add("on-tg");
        setBlend("normal");
      }
    };
    const onOut = (e) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("div", { ref: dotRef, className: "cursor", id: "cursor" }, /* @__PURE__ */ React.createElement("img", { ref: lensRef, id: "cursor-lens-img", alt: "" }))
  );
}
...
function App() {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Nav, { active, onNav }), /* @__PURE__ */ React.createElement(Hero, { layout: t.heroLayout }), /* @__PURE__ */ React.createElement(Marquee, { sep: t.marqueeSep }), /* @__PURE__ */ React.createElement(UtilityRow, null), /* @__PURE__ */ React.createElement(Projects, { variant: t.cardVariant, density: t.density, count: t.projectCount }), /* @__PURE__ */ React.createElement(Career, null), /* @__PURE__ */ React.createElement(Benefits, null), /* @__PURE__ */ React.createElement(Footer, null), /* @__PURE__ */ React.createElement(CursorDot, { enabled: t.spotlight }), /* @__PURE__ */ React.createElement(TweaksPanel, { title: "Tweaks" }, /* @__PURE__ */ React.createElement(TweakSection, { label: "Hero" }), /* @__PURE__ */ React.createElement(
    TweakRadio,
    {
      label: "Layout",
      value: t.heroLayout,
  ...
  ), /* @__PURE__ */ React.createElement(TweakSection, { label: "Projects" }), /* @__PURE__ */ React.createElement(
    TweakRadio,
    {
      label: "Thumbnails",
      value: t.cardVariant,
  ...
  ), /* @__PURE__ */ React.createElement(TweakSection, { label: "Marquee" }), /* @__PURE__ */ React.createElement(
    TweakRadio,
    {
      label: "Separator",
      value: t.marqueeSep,
  ...
  ), /* @__PURE__ */ React.createElement(TweakSection, { label: "Ambient" }), /* @__PURE__ */ React.createElement(
    TweakToggle,
    {
      label: "Custom cursor",
      value: t.spotlight,
